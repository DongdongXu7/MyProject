  ...
  <div>
    ...
    <el-card>
        ...
        <el-form :model="addForm" :rules="addFormRule" ref="addFormRef" label-width="100px" label-position="top">
          ...
          <el-tab-pane label="基本信息" name="0" ref="firstTab">
          ...
          <el-tab-pane label="商品参数" name="1">
            ...
            <el-form-item v-for="item in manyTableData" :key="item.id" :label="item.attr_name">
              <el-checkbox-group v-model="item.attr_vals">
                <el-checkbox :label="itemChild" v-for="(itemChild, index) in item.attr_vals" :key="index" border></el-checkbox>
              </el-checkbox-group>
            </el-form-item>
          </el-tab-pane>
          ...
          <el-tab-pane label="商品内容" name="4">
            ...
            <el-button @click="addGoodsAll" type="primary" class="addGoods">添加商品</el-button>
          </el-tab-pane>
          </el-tabs>
        </el-form>
    </el-card>
